...
public class TrackMeService extends Service {
	...
	new LocationListener() {
		...
		private void sendPosition(String latitude, String longitude) {
			...
			final String message = "Position envoyée : " + deviceName + "@"
					+ latitude + "-" + longitude;
	...
	public void onCreate() {
		...
		if (locationMgr.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
			...
			super.onCreate();
			Toast.makeText(getBaseContext(), "Service SuisMoi : Demarré",
					Toast.LENGTH_LONG).show();
		} else {
	...
	public void onDestroy() {
		Toast.makeText(getBaseContext(), "Service SuisMoi : Arrété",
				Toast.LENGTH_LONG).show();
